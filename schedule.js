...
const numeratorSchedule = {
    1: [ // Понедельник
        { subject: "Уч.практика 1пд", time: "8:35 - 9:55", room: "Ауд. 201" },
        { subject: "Уч.практика 1пд / Выч.тех. 2пд", time: "10:00 - 12:45", room: "Ауд. 201 / Ауд. 103" },
        { subject: "История Кыргызстана", time: "13:05 - 14:25", room: "Ауд. 208" },
    ],
    2: [ // Вторник
        { subject: "ОТС лб 1", time: "8:35 - 9:55", room: "Ауд. 114" },
        { subject: "ОТС", time: "10:00 - 11:20", room: "Ауд. 114" },
        { subject: "Английский язык", time: "11:25 - 12:45", room: "Ауд. 217 / Ауд. 216" },
    ],
    3: [ // Среда
        { subject: "География", time: "13:05 - 14:25", room: "Ауд. 206" },
        { subject: "ОТС", time: "14:30 - 15:50", room: "Ауд. 114" },
        { subject: "Выч.тех. КП 1 / ОТС лб 2", time: "15:55 - 17:15", room: "Ауд. 103 / Ауд. 114" },
        { subject: "Выч.тех. КП 2", time: "17:20 - 18:40", room: "Ауд. 114" }
    ],
    4: [ // Четверг
        { subject: "Выч.тех.", time: "8:35 - 9:55", room: "Ауд. 103" },
        { subject: "Напр. системы", time: "10:00 - 12:45", room: "Ауд. 201" },
        { subject: "Кырг.язык", time: "13:05 - 14:25", room: "Ауд. 304" }
    ],
    5: [ // Пятница
        { subject: "НЕТ", time: "10:00 - 11:20", room: "" },
        { subject: "История Кыргызстана", time: "11:25 - 12:45", room: "Ауд. 208" },
        { subject: "Физ.воспитание", time: "13:05 - 14:25", room: "Ауд. 02" }
    ],
    6: [ // Суббота
...
const denominatorSchedule = {
    1: [ // Понедельник
        { subject: "Уч.практика 2пд", time: "8:35 - 9:55", room: "Ауд. 201" },
        { subject: "Выч.тех. 1пд / Уч.практика 2пд", time: "10:00 - 12:45", room: "Ауд. 103 / Ауд. 201" },
        { subject: "История Кыргызстана", time: "13:05 - 14:25", room: "Ауд. 208" },
    ],
    2: [ // Вторник
        { subject: "ОТС лб 1", time: "8:35 - 9:55", room: "Ауд. 114" },
    ...
    5: [ // Пятница
        { subject: "Кырг.язык", time: "10:00 - 11:20", room: "Ауд. 304" },
        { subject: "История Кыргызстана", time: "11:25 - 12:45", room: "Ауд. 208" },
        { subject: "Физ.воспитание", time: "13:05 - 14:25", room: "Ауд. 02" }
    ],
    6: [ // Суббота
